    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <ul className="text-orange text-lg">
                ...
                <li>- хуки createBrowserRouter, createRoutesFromElements, useLoaderData, useAsyncValue, useNavigation, useActionData, useRouteError</li>
                <li>- утилита defer, redirect, isRouteErrorResponse</li>
